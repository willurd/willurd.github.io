...
const CounterTack = () => (
  ...
  >
    <p>
      My work at CounterTack was eclectic. I did everything from specing, mocking, prototyping and building Flex/AIR and
      Web applications and the backend services that feed them, to domain modeling, interaction and user experience
      design, interfacing with 3rd party applications, developing use cases, raw socket development, and designing and
      ...
      open source projects, and as a team we did some really cutting edge work. It was exciting to say the least.
    </p>
  </Job>
);
